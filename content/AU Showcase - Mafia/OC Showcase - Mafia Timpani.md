...
| **Zodiac**                                                       | Sagittarius                                            |
| **Birthplace**                                                   | Unknown                                                |
| **Hair Color**                                                   | Blue/Lavender, Maroon Highlights                       |
| **Eye Color**                                                    | Blue (one is lighter than the other)                   |
| **Eyesight**                                                     | Can See Good                                           |
| **Dexterity**                                                    | Right-Handed                                           |
| **Voice**                                                        | Femme w/ Medium Pitch (wide fluctiations)              |
...
* Will talk your ear off, but prefers hearing the stories of others
* Likes to see the positive in things (even if that means they’re having fun as chaos ensues)
* Does hide a lot of past behind the cheery exterior
* Very erratic schedule (plays it off as “I’m always on time as I need to be”)
* Very musically inclined; always dancing around, even with visitors
* Bad at letting go of the past, which can come up randomly and impact deals/other events (though few people actually realize that’s what’s going on)

| Likes                       | Dislikes                 |
| --------------------------- | ------------------------ |
| Cute things                 | Liars                    |
| Music/Dancing               | Emotional Manipulators   |
| Alcohol (Fruity Stuff)      | Those who oppose freedom |
| Traveling                   | Boring people            |
| Sight-Seeing                |                          |
| People to swap stories with |                          |
| People with a lot to say    |                          |
#### Formative Experiences:
- Void Incident (They call it this but never explain what that actually means)
#### Dreams:
* Continuing to see more of the show called life, like they’re seeing now
* There was a wine that they had once and could never find again and want to find it one day because it was AMAZING
#### Fears:
- Being alone
...
* No romantic partners or sexual history
	* Would like a partner one day but doesn't really focus on that
...
* Vast wealth of knowledge on firearms, weapons, and other tools
	* *Including more… supernatural items…*
* Good with business
* Not good at CQC; needs weapons.

*Rumors abound of them clearing entire gangs who get in their way.  But no one can really confirm this…*

#### Employment & School
* Standard education (specifics unknown)
* Only took random odd jobs before current endeavors

#### Economics
- Theoretically Rich from their gig
- Doesn't flaunt their wealth a ton, though they do use it for travel and the like
...
- Musical Themes:
	- General Theme: [Morrow's Magic](https://music.youtube.com/watch?v=P0a4uS9gNj4&si=e4QuIsTdYDmmRrNG) *(Not in the shop, out and about, casual, etc)*
	- Shop Themes: [Cait Sith's Theme](https://music.youtube.com/watch?v=Wd5N9TCkasg&si=mbbcuYHgbUDmcm7q), [Hip Shop](https://music.youtube.com/watch?v=D83BxptHcRc&si=w6f_ovL1Ov7W-dyc), [Shuffle or Boogie](https://music.youtube.com/watch?v=YXcrTETl-d4&si=ouEL_H__U1ewsOkt) *(Interchangeable business themes)*
	- Battle Theme (Casual): [Catswing](https://music.youtube.com/watch?v=r-DvoCTarMQ&si=wErT82AZKJqPRJwm) *(Fights that are more casual, or heavily swayed in Timpani’s favor (they like to have fun))*
	- Battle Theme (Extreme): [Insatiable](https://music.youtube.com/watch?v=18q19BPYEJE&si=doUMLBBZv1xfwxMl) *(If required to fight to this point, you’ve really fucked up)*
	- ???: [Vamo Alla Flamenco](https://music.youtube.com/watch?v=RAxmjZVb_HQ&si=chejJMxT2NqEvIF3) *(I’ll decide how this is used later, I just need it in there somewhere.  Possibly as like a “dancing when alone” type thing)*
- Inspirations:
	- Alistor (Hazbin Hotel)
	- Anna (Fire Emblem)
	- Q (007)
	- John Wicke's Weapons/Clothing people 
	- Some IRL stuff but I won't specify how :)